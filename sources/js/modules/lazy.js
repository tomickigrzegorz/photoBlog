...
var responsivelyLazy =
    typeof responsivelyLazy !== 'undefined'
        ? responsivelyLazy
        : (function() {
              ...
              var hasIntersectionObserverSupport =
              ...
              var updateImage = function(container, element) {
                  ...
                  if (options !== null) {
                      ...
                      if (options.length > 0) {
                          ...
                          temp.sort(function(a, b) {
                              ...
                              if (a[1] === b[1]) {
                                  if (
                                      b[0].indexOf('.webp', b[0].length - 5) !==
                                      -1
                                  ) {
                                      return 1;
                                  }
                                  if (
                                      a[0].indexOf('.webp', a[0].length - 5) !==
                                      -1
                                  ) {
                                      return -1;
                                  }
                  ...
                  if (
                      typeof container.responsivelyLazyLastSetOption ===
                      'undefined'
                  ) {
                      container.responsivelyLazyLastSetOption = ['', 0];
                  }
                  if (
                      container.responsivelyLazyLastSetOption[1] <
                      bestSelectedOption[1]
                  ) {
                      container.responsivelyLazyLastSetOption = bestSelectedOption;
                      var url = bestSelectedOption[0];
                      if (
                          typeof container.responsivelyLazyEventsAttached ===
                          'undefined'
                      ) {
                          ...
                          element.addEventListener(
                              'error',
                              function() {
                                  container.responsivelyLazyLastSetOption = [
                                      '',
                                      0
                                  ];
                              },
