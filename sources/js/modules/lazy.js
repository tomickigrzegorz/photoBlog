  ...
  typeof responsivelyLazy !== 'undefined'
    ...
    : (function() {
        ...
        var updateImage = function(container, element) {
          ...
          if (options !== null) {
            ...
            if (options.length > 0) {
              ...
              for (var j = 0; j < optionsCount; j++) {
                ...
                var add = false;
                if (
                  optionImage.indexOf('.webp', optionImage.length - 5) !== -1
                ) {
                  if (hasWebPSupport) {
                    add = true;
                  }
          ...
          if (
            container.responsivelyLazyLastSetOption[1] < bestSelectedOption[1]
          ) {
            container.responsivelyLazyLastSetOption = bestSelectedOption;
            var url = bestSelectedOption[0];
            if (
              typeof container.responsivelyLazyEventsAttached === 'undefined'
            ) {
